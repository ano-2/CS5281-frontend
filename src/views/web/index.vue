<template>
  <div class = "index">
    ...
    <IndexOpinion></IndexOpinion>
    <IndexDevelopment></IndexDevelopment>
    <IndexAccordian></IndexAccordian>
    <AwFooter></AwFooter>
  </div>
</template>
...
import IndexOpinion from '../../components/web/index/indexOpinion'
import IndexDevelopment from '../../components/web/index/indexDevelopment.vue'
import IndexAccordian from '../../components/web/index/indexAccordian.vue'
export default {
  name: 'index',
  components: {
    Banner,
